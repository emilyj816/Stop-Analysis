...
int ScanChain( TChain* chain, bool fast = true, int nEvents = -1, string skimFilePrefix = "test") {
  ...
  for(unsigned int i = 0; i<histonames.size(); ++i){
	...
	if(histonames[i]=="pfmet_cut_n_of_first_bjet"){
	  float xbins[6] = {250, 350, 450, 600, 700, 900};
	  histos[mapname] = new TH1F(mapname.c_str(), "", 5, xbins);
	  continue;

	}
	if(histonames[i]=="pfmet_cut_n_loose_minus_good"){
	  float xbins2[7] = {250, 300, 400, 500, 650, 750, 900};
	  histos[mapname] = new TH1F(mapname.c_str(), "", 6, xbins2);
	  continue;
	}
	if(histonames[i]=="pfmet_cut_dphi_lep_ptmiss"){
	  float xbins3[7] = {250, 300, 400, 500, 600, 700, 900};
	  histos[mapname] = new TH1F(mapname.c_str(), "", 6, xbins3);
	  continue; 
	}
